  ...
  function (
    ...
    return Controller.extend("org.ubb.books.controller.BookList", {
      ...
      handleCheckBooks() {
        ...
        var selRow = this.byId("idcBooksTable")
          .getModel()
          .getProperty(sPath);
        var availableVal = parseInt(selRow.AVAILBLE_BOOKS);

        if (availableVal > 0) {
          selRow.Available = parseInt(selRow.AVAILBLE_BOOKS) - 1;
          ...
          oBook.AVAILBLE_BOOKS = selRow.AVAILBLE_BOOKS;
